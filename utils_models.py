...
class client_model(nn.Module):
    def __init__(self, name, args=True):
        ...
        if self.name in ['emnist', "emnist26"]:
            if self.name == "emnist": self.n_cls = 10
            if self.name == "emnist26": self.n_cls = 26
        ...
        if self.name == 'cifar10':
            ...
            self.bn1.running_mean, self.bn1.running_var = None, None
            
            self.bn2 = nn.BatchNorm2d(64)
            self.bn2.running_mean, self.bn2.running_var = None, None
            
            self.bn3 = nn.BatchNorm1d(384)
            self.bn3.running_mean, self.bn3.running_var = None, None
            
            self.bn4 = nn.BatchNorm1d(192)
            self.bn4.running_mean, self.bn4.running_var = None, None
