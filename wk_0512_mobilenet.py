...
parser.add_argument('--mode', type = str, default = "fedavg", 
                    choices=["feddyn", "scaffold", "fedavg", "fedprox", "fedavg1", "fedavg2", "fedavg3", "fedavg4", "fedavg5",
                             "fedexp", "fedcm", "feddecorr", "feddyn2",
                             "fedadam", "fedadagrad", "fedavgm"])
parser.add_argument('--epoch', type = int, default = 5)
parser.add_argument('--model_name', type = str, choices=["cnn", "resnet", "mobilenetv2", "resnet34"])
parser.add_argument('--norm', type = str, default = "no")

parser.add_argument('--task', type = str, default = "CIFAR100", 
                    choices=["CIFAR10", "CIFAR100", "mnist", "emnist", "TinyImageNet"])
...
if args.model_name == "resnet34": args.extension += "_resnet34"
...
elif args.task == "CIFAR100" and args.model_name == "resnet34":
    savepath = 'Output_GU_C100_Resnet34/{}-{}-B{}-D{}-N{}-P{}_{}'.format(args.task, args.mode, args.balance, args.dist, args.n_clients, args.act_prob, args.extension)
elif args.task == "TinyImageNet" and args.model_name == "resnet34":
    savepath = 'Output_GU_TIN_Resnet34/{}-{}-B{}-D{}-N{}-P{}_{}'.format(args.task, args.mode, args.balance, args.dist, args.n_clients, args.act_prob, args.extension)
