...
parser.add_argument('--model_name', type = str, default = "cnn", choices=["cnn", "resnet18", "mobilenetv2"])
...
if args.model_name == "resnet18": args.extension += "_resnet"
...
# ==============================================
if args.task == "CIFAR100" and args.model_name == "resnet18":
...
elif args.task == "TinyImageNet" and args.model_name == "resnet18":
...
train(args=args, data_obj=data_obj, 
